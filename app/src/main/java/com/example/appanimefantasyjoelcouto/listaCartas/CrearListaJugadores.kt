...
fun CrearListaJugadores(): List<JugadorAnime> {
    ...
    val listaJugadores = listOf<JugadorAnime>(
        JugadorAnime(
            ...
            "Roronoa Zoro",
            "Roronoa Zoro (ロロノア・ ゾロ Roronoa Zoro?),[13] conocido como El Cazador de Piratas (海賊狩り Kaizoku Gari?),[14] es el combatiente principal de los Piratas de Sombrero de Paja, uno de sus dos espadachines y uno de los oficiales principales de la Gran Flota de Sombrero de Paja, así como un antiguo cazarrecompensas.[15][1]\n" +
                    "\n" +
                    "Nacido en el East Blue, Zoro es hijo de Tera y Roronoa Arashi, nieto de Shimotsuki Furiko y Roronoa Pinzoro, y sobrino nieto de Shimotsuki Ushimaru, lo que le convierte en descendiente matrilineal tanto de la familia Shimotsuki del País de Wano como del legendario samurái Shimotsuki Ryuma.[5] Fue el primer miembro en unirse a la tripulación,[16] y es considerado parte del Trío Monstruoso (怪物三人組 Kaibutsu San-ningumi?) junto a Luffy y Sanji.[17][18] Su sueño es convertirse en el mejor espadachín del mundo.[19] Zoro también es considerado uno de los Once Supernovas que forman parte de «la peor generación».[20]\n" +
                    "\n" +
                    "Obtuvo su primera recompensa de Belly60.000.000 tras el arco de Arabasta. Más tarde aumentó a Belly120.000.000 tras el incidente de Enies Lobby, y de nuevo a Belly320.000.000 tras el arco de Dressrosa.[21] Tras el asalto a Onigashima, su recompensa aumentó a Belly1.111.000.000, siendo la segunda más alta de la tripulación solo superada por la de Luffy.[22]",
